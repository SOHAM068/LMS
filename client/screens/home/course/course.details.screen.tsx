...
export default function CourseDetailScreen() {
  ...
  // console.log("courseData", user?.courses);

  const handleAddToCart = async () => {
    const existingCartData = await AsyncStorage.getItem("cart"); // get cart data from async storage if exists else return empty array

    // console.log("existingCartData", existingCartData);
    const cartData = existingCartData ? JSON.parse(existingCartData) : []; // parse the existing cart data, parse means convert string to array of objects
